...
#seeding artists
  artist1 = Artist.create!(first_name: "Amparo", last_name: "Cruz Herrera", description: "Fille du célèbre peintre José Cruz Herrera Linense", birth_date: Date.new(1926,10,4), death_date: Date.new(2003,11,12))
  artist1.remote_photo_url = "https://res.cloudinary.com/artket/image/upload/v1536570709/amparo_cruz_herrera.jpg"
  artist1.save
#seeding artists
  artist2 = Artist.create!(first_name: "Hassan", last_name: "El Glaoui", description: "Peintre marocain formé à l'Académie des Beaux Arts de Paris", birth_date: Date.new(1924,9,4), death_date: Date.new(2003,11,12))
  ...
  artist2.save
#seeding artists
  artist3 = Artist.create!(first_name: "Chaïbia", last_name: "Tallal", description: "Peintre marocaine, pionniraire du style brut", birth_date: Date.new(1929,10,4), death_date: Date.new(2004,11,12))
  ...
  artist3.save
#seeding artists
  artist4 = Artist.create!(first_name: "Saad", last_name: "Ben Cheffaj", description: "Artiste multidisciplinaire qui allie peinture et poésie", birth_date: Date.new(1939,10,4), death_date: Date.new(2003,11,12))
  ...
  artist4.save
#seeding artists
  artist5 = Artist.create!(first_name: "Shepard", last_name: "Fairey", description: "Artiste américain, sérigraphe, muraliste et illustrateur", birth_date: Date.new(1970,10,4), death_date: Date.new(2003,11,12))
  artist5.remote_photo_url = "https://res.cloudinary.com/artket/image/upload/v1536573488/Shepard-Fairey-featured-555x312.jpg"
  artist5.save
#seeding artists
  artist6 = Artist.create!(first_name: "Richard", last_name: "Mirando", description: "Alias Seen, reconnu comme le parain du graffiti", birth_date: Date.new(1961,10,4), death_date: Date.new(2003,11,12))
  artist6.remote_photo_url = "https://res.cloudinary.com/artket/image/upload/v1536574052/Seen_Kool.jpg"
  artist6.save
#seeding artists
  artist7 = Artist.create!(first_name: "Hussein", last_name: "Tallal", description: "Artiste autodidacte", birth_date: Date.new(1961,10,4), death_date: Date.new(2003,11,12))
  ...
  artist7.save
#seeding artists
  artist8 = Artist.create!(first_name: "Choukri", last_name: "Regragui", description: "Génie du réalisme pictural", birth_date: Date.new(1961,10,4), death_date: Date.new(2003,11,12))
  artist8.remote_photo_url = "https://res.cloudinary.com/artket/image/upload/v1536579111/Choukri-Regragui-.jpg"
  artist8.save
#seeding artists
  artist9 = Artist.create!(first_name: "Abderrahim", last_name: "Iqbi", description: "Artiste tragique", birth_date: Date.new(1961,10,4), death_date: Date.new(2003,11,12))
  artist9.remote_photo_url = "https://res.cloudinary.com/artket/image/upload/v1536579806/abderrahim_iqbi_nb.jpg"
  artist9.save
#seeding artists
  artist10 = Artist.create!(first_name: "Nabil", last_name: "Boudarqa", description: "Artiste tragique", birth_date: Date.new(1961,10,4), death_date: Date.new(2003,11,12))
  artist10.remote_photo_url = "https://res.cloudinary.com/artket/image/upload/v1536580099/articlesprincipaleskf3a8337.jpg"
  artist10.save
#seeding artists
  artist11 = Artist.create!(first_name: "Youssef", last_name: "Douieb", description: "Artiste moderne", birth_date: Date.new(1961,10,4), death_date: Date.new(2003,11,12))
